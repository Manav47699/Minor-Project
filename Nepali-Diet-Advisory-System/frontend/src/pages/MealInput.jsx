...
const KNOWN_FIELDS = ['description', 'image'];
...
export default function MealInput() {
  ...
  const onSubmit = async (data) => {
    ...
    if (!desc && !hasImage) {
      setGeneralError('Please enter what you ate today using text description, a photo, or both.');
      return;
    }
        ...
        <div className="bg-[#FAF8F5] border border-[#E5E1D8] p-6 sm:p-8 rounded-xs space-y-6">
          ...
          <div className="border-b border-[#E5E1D8] pb-5">
            ...
            <p className="font-ui text-sm text-[#57554F] mt-1">
              Please enter what you ate today
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6" noValidate>
            ...
            <div>
              ...
              <p className="font-ui text-xs text-[#85837C] mb-2">
                Describe your food items and approximate portions (e.g., 1 plate Dal Bhat, Chicken Curry, Saag).
              </p>
              <textarea
                id="description"
                rows={4}
                disabled={isSubmitting}
                placeholder="e.g. 1 plate Dal Bhat (rice, yellow lentil soup), Saag (mustard greens), Achar, and Chicken curry"
            ...
            {/* 2. Photo Upload (Optional / Multi-modal) */}
            <div className="border-t border-[#E5E1D8] pt-5 space-y-4">
              <div>
                ...
                <p className="font-ui text-xs text-[#85837C] mb-3">
                  Upload a photo of your food plate for automated vision analysis.
                </p>
              ...
              <div className="p-3.5 bg-[#F3F0EA] border border-[#E5E1D8] text-[#181715] text-xs font-ui rounded-xs flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <span className="text-[#57554F] text-[11px]">
                    Analyzing food items, evaluating macronutrients, and preparing personalized recommendations...
                  </span>
                </div>
              </div>
            )}
              ...
              >
                {isSubmitting ? (
                  <>
                    ...
                    <span>Analyzing &amp; Saving Meal...</span>
                  </>
                ) : (
                  'Save Meal Entry'
                )}
